...
public class Compiler {
	...
	public static void main(String[] args) throws IOException, InterruptedException
	{
		...
		for (int i=1; i<=22; ++i) {
	    	...
	    	//String sourceFilename = String.format("C:/users/David/workspace/Lab6_CodeGeneration/project6_tests/test%02d.crx", i);
    		crux(sourceFilename);
    		spim(sourceFilename);
    	}
    }
	...
	public static void spim(String sourceFilename) throws IOException, InterruptedException
	{
		...
		//Process spim = Runtime.getRuntime().exec("C:/Program Files (x86)/QtSpim/QtSpim.exe -file " + asmFilename);
